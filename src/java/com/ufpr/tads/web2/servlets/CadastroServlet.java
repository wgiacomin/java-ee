        ...
        try {
            ...
            switch (action) {
                ...
                case "alterar_senha":
                    ...
                    if (!senha.equals(senhaConfirm)) {
                        msg = "Senhas não coincidem";
                        throw new CampoInvalidoAlterarException();
                    } else if (senha.length() <= 6) {
                        msg = "Senha deve ser maior que 6 caracteres";
                        throw new CampoInvalidoAlterarException();
                    }
                    ...
                    if (login == null) {
                        ...
                        msg = "Ops! Alguma coisa aconteceu.";
                    ...
                    try {
                        ...
                        LoginFacade.editarSenha(login);
                        msg = "Alterado com sucesso!";
                    } catch (FacadeException e) {
                        msg = "Não foi possível alterar a senha senha;";
                        throw new CampoInvalidoAlterarException();
                    }
            ...
            rd.forward(request, response);
        } catch (CampoInvalidoAlterarException ex) {
            RequestDispatcher rd = getServletContext().getRequestDispatcher("/alterarSenha.jsp");
            request.setAttribute("msg", msg);
            rd.forward(request, response);
        }
