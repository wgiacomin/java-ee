<%@include file="utils/header.jsp" %>
    <a href="AtendimentoServlet?action=formNew" class="btn btn-outline-success my-3">Novo Atendimento</a>
            ...
            <c:forEach var="a" varStatus="i" items="${lista}" >                        
                <tr>
                    ...
                    <td class="text-center">
                        <a href="AtendimentoServlet?id=<c:out value="${a.id}"/>&action=details"> 
